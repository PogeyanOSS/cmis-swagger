...
//		Session session = SwaggerHelpers.getSession(repositoryId, userName, password);
//		ObjectType typdefinitioneobj = SwaggerHelpers.getType(typeId);
//		String typeIdName = SwaggerHelpers.getIdName(typdefinitioneobj);
//		String customId = null;
//		if (SwaggerHelpers.customTypeHasFolder()) {
//			customId = typdefinitioneobj.isBaseType() ? objectId : typeId + "::" + typeIdName + "::" + objectId;
//		} else {
//			customId = objectId;
//		}
//		CmisObject object = session.getObject(customId);
//		LOG.info("class name: {}, method name: {}, repositoryId: {}, type: {}, object: {}", "SwaggerApiService",
//				"invokePutMethod", repositoryId, typeId, objectId);
//		if (object != null && typdefinitioneobj.getId().equals(object.getType().getId())) {
//			Map<String, Object> serializeMap = deserializeInput(input, typdefinitioneobj, session);
//			Map<String, Object> updateProperties = SwaggerApiServiceFactory.getApiService().beforeUpdate(session,
//					serializeMap, object.getPropertyValue("revisionId"));
//			if (updateProperties != null) {
//				CmisObject updatedObj = object.updateProperties(updateProperties);
//				Map<String, Object> propMap = compileProperties(updatedObj, session);
//				return propMap;
//			}
//			return null;
//		} else {
...
//	 * @throws Exception
//	 */
//	public static boolean invokeDeleteTypeDefMethod(String repositoryId, String typeId, String userName,
//			String password) throws Exception {
//		Session session = SwaggerHelpers.getSession(repositoryId, userName, password);
//		TypeDefinition typeDefinition = session.getTypeDefinition(typeId);
//		LOG.info("class name: {}, method name: {}, repositoryId: {}, type: {}", "SwaggerApiService",
//				"invokeDeleteTypeDefMethod", repositoryId, typeId);
...
//	 * @throws Exception
//	 */
//	public static TypeDefinition invokePutTypeDefMethod(String repositoryId, String typeId, InputStream inputType,
